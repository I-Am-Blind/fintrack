...
import { FaShieldVirus,FaRegNewspaper,FaPhone } from "react-icons/fa";
  ...
  return (
    <div className="font-primary h-screen w-screen bg-bgimage bg-no-repeat bg-cover bg-center bg-fixed flex flex-row justify-between px-40 text-white">
            ...
            <div className='pt-40' >
                ...
                <img className="pt-20" src={phone} />
            </div>
            <div className='pt-40'>
                <div className='flex pb-5 '>
                    <FaShieldVirus size={"25px"}/>
                    <h4 className='pl-3 text-xl'>A description of how user data is collected, used and protected.</h4>
                </div>
                <div className='flex pb-5'>
